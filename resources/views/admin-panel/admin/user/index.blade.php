                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                @forelse($paginator as $user)
                                    ...
                                    <tr class="{{ $class }}">
                                        ...
                                        <td>
                                            <a href="{{ route('adminzone.admin.users.edit', $user->id) }}" title="Редактировать пользователя">
                                                <i class="btn btn-xs"></i>
                                                <button type="submit" class="btn btn-success btn-xs">Просмотреть</button>
                                            </a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a class="btn btn-xs">
                                                <form method="post" action="{{ route('adminzone.admin.users.destroy', $user->id) }}" style="float: none">
                                                    @method('DELETE')
                                                    @csrf
